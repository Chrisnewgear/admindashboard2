...
// Future<void> _saveOrUpdateEmployee(Usuario employee, List<Usuario> selectedUsers) async {
//   try {
//     // Convertir la lista de usuarios seleccionados a un formato compatible con Firebase
//     final selectedUsersData = selectedUsers.map((user) => user.toMap()).toList();

//     // Referencia al documento del usuario en Firebase
//     final userDoc = FirebaseFirestore.instance.collection('Users').doc(employee.codigo);

//     // Guardar o actualizar los datos en Firebase
//     await userDoc.set({
//       'MyTeam': selectedUsersData,
//     }, SetOptions(merge: true)); // Merge para no sobrescribir otros campos

//     // Mostrar un SnackBar indicando éxito
//     ScaffoldMessenger.of(context).showSnackBar(
...
//     // Buscar el documento cuyo campo 'Codigo' coincida con el valor de employee.codigo
//     final userQuerySnapshot = await FirebaseFirestore.instance
//         .collection('Users')
//         .where('Codigo', isEqualTo: employee.codigo) // Buscar por el campo 'Codigo'
//         .limit(1) // Limitar la búsqueda a un solo documento
//         .get();

//     // Verificar si se encontró un documento con el 'Codigo' especificado
//     if (userQuerySnapshot.docs.isEmpty) {
//       throw Exception('Usuario no encontrado con el código: ${employee.codigo}');
//     }

//     // Obtener la referencia al primer documento encontrado
//     final userDoc = userQuerySnapshot.docs.first.reference;

//     // Actualizar el campo 'MyTeam' dentro del documento encontrado
//     await userDoc.update({
//       'MyTeam': selectedUsersData, // Guardamos la lista de vendedores en el campo 'MyTeam'
//     });
