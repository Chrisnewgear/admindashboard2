                    ...
                    child: LayoutBuilder(
                      builder:
                        ...
                        return SingleChildScrollView(
                          // Add another SingleChildScrollView for the form content
                          child: Column(
                            mainAxisSize: MainAxisSize.min,
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Flexible(
                                // Make the logo section flexible
                                child: Row(
                                  children: [
                                    const Spacer(),
                                    Padding(
                                      ...
                                      child: Image.asset(
                                        ...
                                        height: constraints.maxWidth > 600
                                            ? 200
                                            : 150, // Adjust size based on width
                              ...
                              Text(
                                ...
                                style: GoogleFonts.roboto(
                                  fontSize:
                                      constraints.maxWidth > 600 ? 30 : 24,
                              ...
                              Padding(
                                ...
                                child: constraints.maxWidth > 600
                                    ? Column(
                                        children: [
                                          _buildRowFields(_name, _surname,
                                              'Nombre*', 'Apellido*'),
                                          const SizedBox(height: 15),
                                ...
                                onTap: () async {
                                  if (_formKey.currentState?.validate() ??
                                    ...
                                    try {
                                      ...
                                      if (emailExists) {
                                        showCustomAlert(
                                            context, 'Email ya existe');
                                        setState(() {
                                          _isLoading =
                                              false; // Desactivar loading
                                        });
                                        return;
                                      }
